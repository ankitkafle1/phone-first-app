...
import type { HomeRoomPreview } from '../homeData';

type RoomHomeCardProps = {
  isExpanded: boolean;
  item: HomeRoomPreview;
  onToggle: () => void;
};

export function RoomHomeCard({ isExpanded, item, onToggle }: RoomHomeCardProps) {
  return (
        ...
        <View style={styles.expandedPanel}>
          ...
          <View style={styles.panelHeader}>
            ...
            <Text style={styles.panelHint}>
              {item.listingType} · {item.price} · {item.location}
            </Text>
          </View>
          <Text style={styles.detailText}>{item.description}</Text>
          <View style={styles.actionRow}>
            <Pressable
              accessibilityLabel={`Call owner for ${item.title}`}
            ...
            <Link href="/rooms" asChild>
              <Pressable style={({ pressed }) => [styles.actionButton, pressed && styles.pressed]}>
                ...
                <Text style={styles.actionText}>Open Rooms</Text>
              </Pressable>
            </Link>
          </View>
        </View>
